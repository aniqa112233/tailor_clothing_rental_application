...
//   // 🔹 Fetch all designs with status = 'pending'
//   Future<void> _fetchPendingDesigns() async {
//     setState(() => loading = true);
//     final response =
//         await supabase.from('custom_designs').select().eq('status', 'pending');
//     setState(() {
...
//             onPressed: _fetchPendingDesigns,
//           )
//         ],
//       ),
//       body: loading
...
//   // 🔹 Fetch designs with status = 'pending'
//   Future<void> _fetchPendingDesigns() async {
//     try {
//       setState(() => loading = true);
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text('Error fetching designs: $e')),
//       );
//     }
//   }
...
//     } catch (e) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text('Error approving design: $e')),
//       );
//     }
//   }
...
//     } catch (e) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text('Error rejecting design: $e')),
//       );
//     }
//   }
